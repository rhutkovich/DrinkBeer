...
public class DrinkBeer implements ModInitializer {
    ...
    /*------------------------------------------------------------------------------------------------------------------*/
    //Beers
    // TODO block settings are Material.METAL by default? check how to make it WOOD
    ...
    static {
        BEER_BARREL_SCREEN_HANDLER = Registry.register(Registries.SCREEN_HANDLER, BEER_BARREL_ID, new ScreenHandlerType<>(BeerBarrelScreenHandler::new, FeatureSet.empty()));
    }
    ...
    static {
        BARTENDING_TABLE_SCREEN_HANDLER = Registry.register(Registries.SCREEN_HANDLER, BARTENDING_TABLE_ID, new ScreenHandlerType<>(BartendingTableScreenHandler::new, FeatureSet.empty()));
    }
    ...
    static {
        TRADE_BOX_SCREEN_HANDLER = Registry.register(Registries.SCREEN_HANDLER, TRADE_BOX_ID, new ScreenHandlerType<>(TradeBoxScreenHandler::new, FeatureSet.empty()));
    }
